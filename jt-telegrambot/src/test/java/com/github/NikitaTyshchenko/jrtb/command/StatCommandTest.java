...
import static com.github.NikitaTyshchenko.jrtb.command.CommandName.STAT;
import static com.github.NikitaTyshchenko.jrtb.command.StatCommand.STAT_MESSAGE;
...
public class StatCommandTest {
    ...
    public void shouldProperlySendMessage() {
        ...
        //then
        Mockito.verify(sendBotMessageService).sendMessage(Long.valueOf(chatId.toString()), format(STAT_MESSAGE,
